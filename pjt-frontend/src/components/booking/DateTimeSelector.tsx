...
export function DateTimeSelector({ professionalId, onSelect, onBack }: DateTimeSelectorProps) {
  ...
  const dates = Array.from({ length: 14 }, (_, i) => {
    ...
    return date
  }).filter(date => date.getDay() !== 0).slice(0, 7) // Remove Sundays, take first 7
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Escolha data e horário</h2>
            ...
            return (
              ...
              >
                <div className="text-sm text-gray-500">
                  {isToday ? 'Hoje' : date.toLocaleDateString('pt-BR', { weekday: 'short' })}
                </div>
