          ...
          <div className='flex flex-col sm:flex-row gap-2'>
            <Dialog
              ...
              <DialogTrigger asChild>
                <Button
                  variant='outline'
                  className='border-[#D4AF37]/20 hover:bg-[#D4AF37]/10 text-sm h-8'>
                    ...
                    {roles.length > 0 ? (
                      ...
                      <>
                        <Input
                          value='Profissional'
                          disabled
                          className='bg-[#F0F0EB] text-[#737373] h-8 text-sm'
                        />
                        <input
                          type='hidden'
                        ...
                        <p className='text-xs text-[#8B4513] mt-1'>
                          ⚠️ Crie funções primeiro ou aguarde implementação do
                          backend
                        </p>
                      </>
                    )}
        ...
        <div className='space-y-3'>
          <div>
            ...
            <ul className='mt-2 text-xs sm:text-sm text-[#737373] space-y-1'>
              <li>
                • <strong>Cria usuário:</strong> Login para acessar o sistema
              </li>
              <li>
                • <strong>Cria profissional:</strong> Aparece na lista de
                profissionais
              </li>
              <li>
                • <strong>Vincula à filial:</strong> Funcionário fica associado
                à filial selecionada
              </li>
              <li>
                • <strong>Função personalizada:</strong> Título e comissão
                definidos por você
              </li>
            </ul>
          </div>
          ...
          {roles.length > 0 && (
            <div>
              <h4 className='text-xs sm:text-sm font-medium text-[#1A1A1A] mb-2'>
                Funções Disponíveis:
              </h4>
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                {roles.map((role: any) => (
                  <div
                    key={role.id}
                    className='border rounded p-2 text-xs sm:text-sm'>
                        ...
                        <div className='text-[#737373] space-y-1'>
                          ...
                          {role.baseSalary && (
                            <div className='text-green-600'>
                              Salário: R$ {Number(role.baseSalary).toFixed(2)}{' '}
                              (dia {role.salaryPayDay})
                            </div>
                          )}
                        </div>
                      </div>
