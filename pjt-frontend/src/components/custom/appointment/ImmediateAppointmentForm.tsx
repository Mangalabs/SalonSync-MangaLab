...
export function ImmediateAppointmentForm({ onSuccess }: ImmediateAppointmentFormProps) {
  ...
  const { form, mutation } = useAppointmentForm('immediate', professionals, () => {
    onSuccess?.()
  })
  ...
  const branchData = useFormQueries(undefined, undefined, false, selectedBranchId)
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <h3 className="text-lg font-semibold text-gray-800 mb-6">Registrar Atendimento Imediato</h3>
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-3">Serviços Realizados</label>
          ...
          <div className="flex space-x-4">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-green-500 to-emerald-500 text-white py-3 px-6 rounded-xl font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
            >
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="space-y-3">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-semibold">{selectedServices.length} realizados</span>
            </div>
        ...
        <div className="bg-green-50 rounded-2xl p-6 border border-green-200">
          <h4 className="font-semibold text-green-800 mb-2">Atendimento Imediato</h4>
