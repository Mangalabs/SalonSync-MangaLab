...
export function AppointmentQueueCard({
  ...
  const isOverdue =
    isToday && scheduledAt < now && appointment.status === 'SCHEDULED'
  ...
  return (
    <div
      className={`p-3 rounded-lg border ${styles.border} ${styles.bg} transition-all`}>
      <div className='flex items-start justify-between'>
        <div className='flex items-start gap-2 flex-1'>
          <div
            className={`w-2 h-2 rounded-full ${styles.indicator} mt-2 flex-shrink-0`}></div>
